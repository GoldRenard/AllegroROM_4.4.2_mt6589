...
.method private parseApplication(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;I[Ljava/lang/String;)Z
    ...
    .end local v35    # "requiredAccountType":Ljava/lang/String;
    .end local v36    # "restrictedAccountType":Ljava/lang/String;
    ...
    .line 2090
    .restart local v35    # "requiredAccountType":Ljava/lang/String;
    .restart local v36    # "restrictedAccountType":Ljava/lang/String;
    :cond_14
    const/4 v3, 0x0
...
.method public collectCertificates(Landroid/content/pm/PackageParser$Package;I)Z
    ...
    .restart local v8    # "jarEntry":Ljava/util/jar/JarEntry;
    ...
    invoke-virtual {v9, v15}, Ljava/util/jar/JarFile;->getEntry(Ljava/lang/String;)Ljava/util/zip/ZipEntry;

    move-result-object v10

    .line 669
    .local v10, "je":Ljava/util/zip/ZipEntry;
    if-eqz v10, :cond_3
    ...
    .line 729
    .end local v8    # "jarEntry":Ljava/util/jar/JarEntry;
    .end local v10    # "je":Ljava/util/zip/ZipEntry;
    :cond_3
    invoke-virtual {v9}, Ljava/util/jar/JarFile;->close()V
