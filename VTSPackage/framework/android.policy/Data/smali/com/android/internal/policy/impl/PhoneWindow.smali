...
.method static synthetic access$1700(Lcom/android/internal/policy/impl/PhoneWindow;)Lcom/android/internal/policy/impl/PhoneWindow$DecorView;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/policy/impl/PhoneWindow;
...
.method static synthetic access$1900(Lcom/android/internal/policy/impl/PhoneWindow;)Landroid/view/ViewGroup;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/policy/impl/PhoneWindow;
...
.method static synthetic access$2000(Lcom/android/internal/policy/impl/PhoneWindow;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/policy/impl/PhoneWindow;
    .param p1, "x1"    # I
...
.method private installDecor()V
    ...
    invoke-virtual {v9, v12}, Landroid/view/ViewGroup;->setDescendantFocusability(I)V

    .line 3184
    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    invoke-virtual {v9, v10}, Landroid/view/View;->setIsRootNamespace(Z)V

    .line 3185
    iget-boolean v9, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mInvalidatePanelMenuPosted:Z

    if-nez v9, :cond_0

    iget v9, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mInvalidatePanelMenuFeatures:I
    ...
    iget-object v12, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mInvalidatePanelMenuRunnable:Ljava/lang/Runnable;

    invoke-virtual {v9, v12}, Landroid/view/View;->postOnAnimation(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v9}, Landroid/view/ViewGroup;->makeOptionalFitsSystemWindows()V

    .line 3195
    const v9, 0x1020016

    invoke-virtual {p0, v9}, Landroid/view/Window;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {v9, v12}, Lcom/android/internal/widget/ActionBarView;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-virtual {v9, v12}, Lcom/android/internal/widget/ActionBarView;->setWindowTitle(Ljava/lang/CharSequence;)V
    ...
    :goto_2
    invoke-virtual {v0, v9}, Lcom/android/internal/widget/ActionBarOverlayLayout;->setOverlayMode(Z)V
    ...
    invoke-virtual {v9, v6}, Lcom/android/internal/widget/AbsActionBarView;->setSplitView(Lcom/android/internal/widget/ActionBarContainer;)V
    ...
    invoke-virtual {v9, v7}, Lcom/android/internal/widget/AbsActionBarView;->setSplitWhenNarrow(Z)V
    ...
    invoke-virtual {v2, v6}, Lcom/android/internal/widget/AbsActionBarView;->setSplitView(Lcom/android/internal/widget/ActionBarContainer;)V

    .line 3253
    invoke-virtual {v2, v5}, Lcom/android/internal/widget/ActionBarContextView;->setSplitActionBar(Z)V

    .line 3254
    invoke-virtual {v2, v7}, Lcom/android/internal/widget/AbsActionBarView;->setSplitWhenNarrow(Z)V
    ...
    :cond_9
    :goto_5
    iget v9, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mResourcesSetFlags:I

    and-int/lit8 v9, v9, 0x1

    if-nez v9, :cond_a

    iget v9, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mIconRes:I

    if-eqz v9, :cond_12

    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v9}, Lcom/android/internal/widget/ActionBarView;->hasIcon()Z
    ...
    iget v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mIconRes:I

    invoke-virtual {v9, v10}, Lcom/android/internal/widget/ActionBarView;->setIcon(I)V
    ...
    iget v9, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mLogoRes:I

    if-eqz v9, :cond_d

    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v9}, Lcom/android/internal/widget/ActionBarView;->hasLogo()Z
    ...
    iget v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mLogoRes:I

    invoke-virtual {v9, v10}, Lcom/android/internal/widget/ActionBarView;->setLogo(I)V

    .line 3284
    :cond_d
    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    new-instance v10, Lcom/android/internal/policy/impl/PhoneWindow$2;

    invoke-direct {v10, p0}, Lcom/android/internal/policy/impl/PhoneWindow$2;-><init>(Lcom/android/internal/policy/impl/PhoneWindow;)V

    invoke-virtual {v9, v10}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    goto/16 :goto_1

    .end local v5    # "splitActionBar":Z
    .end local v6    # "splitView":Lcom/android/internal/widget/ActionBarContainer;
    ...
    .restart local v5    # "splitActionBar":Z
    :cond_f
    move v7, v11
    ...
    .line 3263
    .restart local v6    # "splitView":Lcom/android/internal/widget/ActionBarContainer;
    :cond_11
    if-eqz v5, :cond_9
    ...
    invoke-virtual {v9, v10}, Lcom/android/internal/widget/ActionBarView;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iput v9, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mResourcesSetFlags:I
...
.method private openPanel(Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    invoke-static {v0, v4, v2}, Lcom/lenovo/ideaui/hook/IdeaUI_HookPhoneWindow;->openPanel(Landroid/view/Window;Landroid/content/Context;Landroid/view/WindowManager$LayoutParams;)V
...
.method public ideaUI_fitSystemWindows(Landroid/graphics/Rect;)V
    .locals 3
