...
.field private mPowerMonitor:Lcom/android/server/power/LenovoPowerMonitor;
...
.field private mRGBLight:Lcom/android/server/LightsService$Light;
...
.method public constructor <init>()V
    ...
    .line 439
    iput-boolean v4, p0, Lcom/android/server/power/PowerManagerService;->mProximityPositiveForceScreenOn:Z
    ...
    .line 487
    iput v4, p0, Lcom/android/server/power/PowerManagerService;->mButtonBrightnessModeSetting:I
    ...
    .line 3980
    iput-object v5, p0, Lcom/android/server/power/PowerManagerService;->mSmartStandByConnection:Landroid/content/ServiceConnection;

    .line 3981
    iput-boolean v4, p0, Lcom/android/server/power/PowerManagerService;->mIsBound:Z
    ...
    invoke-static {v4, v2, v5}, Landroid/os/MessageMonitorLogger;->newMessageLogger(ZLjava/lang/String;Landroid/os/MessageMonitorLogger$MessageLoggerCallbacks;)Landroid/os/MessageMonitorLogger;
    ...
    .line 515
    invoke-static {v6, v6}, Lcom/android/server/power/PowerManagerService;->nativeSetPowerState(ZZ)V
...
.method static synthetic access$2500(Lcom/android/server/power/PowerManagerService;J)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # J
...
.method static synthetic access$3400(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/DisplayPowerController;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$3602(Lcom/android/server/power/PowerManagerService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # Z
...
.method static synthetic access$4800(Lcom/android/server/power/PowerManagerService;)Lcom/mediatek/common/hdmi/IHDMINative;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$5302(Lcom/android/server/power/PowerManagerService;Lcom/lenovo/smartstandby/ISmartStandByServiceBinder;)Lcom/lenovo/smartstandby/ISmartStandByServiceBinder;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method private bindSmartStandByService()V
    ...
    const-string v3, "com.lenovo.smartstandby.SMART_STANDBY_SERVICE"
...
.method private checkUserActivtyPermission(I)Z
    .locals 6
    .param p1, "uid"    # I
    ...
    const-string v5, "com.lenovo.smartstandby"
    ...
    const-string v5, "smartstandby called useractivity"
...
.method private static native nativeIsLcdFunctionSupport(Ljava/lang/String;)Z
.end method
...
.method private static native nativeSetGamma(I)V
.end method

.method private static native nativeSetIE(I)V
.end method

.method private static native nativeSetInteractive(Z)V
.end method

.method private static native nativeSetInverseColor(I)V
.end method
...
.method private releaseWakeLockByTag(Ljava/lang/String;)V
    .locals 5
    ...
    .line 3318
    const-string v2, "GuZY"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "releaseWakeLockByTag hit tag : "
...
.method private updateDisplayPowerStateLocked(I)V
    ...
    :goto_1
    invoke-virtual {v7, v4}, Lcom/android/server/power/Notifier;->setWasDimOrOff(Z)V
...
.method private updateSettingsLocked()V
    ...
    const-string v6, "updateSettingsLocked: mScreenBrightnessModeSetting="
...
.method private updateUserActivitySummaryLocked(JI)V
    ...
    .prologue
    .line 2054
    iget-boolean v7, p0, Lcom/android/server/power/PowerManagerService;->mIsPrebootIPO:Z
    ...
    const-string v8, "Ignore updateUserActivitySummaryLocked during IPO boot"
    ...
    invoke-direct {p0, v6}, Lcom/android/server/power/PowerManagerService;->getButtonLightDurationLocked(I)I

    move-result v4

    .line 2072
    .local v4, "screenButtonLightDuration":I
    const/4 v7, 0x0
    ...
    .line 2074
    iget-wide v7, p0, Lcom/android/server/power/PowerManagerService;->mLastUserActivityButtonTime:J
    ...
    invoke-virtual {v7, v1, v2, v3}, Lcom/android/server/power/PowerManagerService$PowerManagerHandler;->sendMessageAtTime(Landroid/os/Message;J)Z

    .line 2145
    .end local v1    # "msg":Landroid/os/Message;
    .end local v4    # "screenButtonLightDuration":I
    ...
    const-string v9, "updateUserActivitySummaryLocked: mWakefulness="
    ...
    .line 2078
    .restart local v4    # "screenButtonLightDuration":I
    ...
    const-string v9, "BRIGHT start to detect--------now = "
    ...
    .line 2087
    iget-object v7, p0, Lcom/android/server/power/PowerManagerService;->mISmartStandByServiceBinder:Lcom/lenovo/smartstandby/ISmartStandByServiceBinder;
    ...
    const-string v8, "start to open face detect"
    ...
    invoke-interface {v7}, Lcom/lenovo/smartstandby/ISmartStandByServiceBinder;->scheduleStartFaceDetect()V
    :try_end_0
    ...
    .line 2128
    :cond_b
    iget-boolean v7, p0, Lcom/android/server/power/PowerManagerService;->mSBSleeped:Z
...
.method public isLcdFunctionSupport(Ljava/lang/String;)Z
    .locals 2
    ...
    const-string v1, "isLcdFunctionSupport"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 3278
    invoke-static {p1}, Lcom/android/server/power/PowerManagerService;->nativeIsLcdFunctionSupport(Ljava/lang/String;)Z
...
.method public releaseWakeLockByTags([Ljava/lang/String;)V
    .locals 7
    ...
    .line 3302
    :cond_1
    const-string v4, "GuZY"

    const-string v5, "releaseWakeLockByTags"
    ...
    const-string v6, "releaseWakeLockByTags remove tag : "
    ...
    .line 3305
    invoke-direct {p0, v3}, Lcom/android/server/power/PowerManagerService;->releaseWakeLockByTag(Ljava/lang/String;)V
...
.method public setGammaMode(I)V
    ...
    const-string v1, "setGammaMode"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 3269
    invoke-static {p1}, Lcom/android/server/power/PowerManagerService;->nativeSetGamma(I)V
...
.method public setIEMode(I)V
    ...
    const-string v1, "setIEMode"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 3274
    invoke-static {p1}, Lcom/android/server/power/PowerManagerService;->nativeSetIE(I)V

    .line 3275
    return-void
.end method

.method public setInverseColor(I)V
    .locals 2
    .param p1, "mode"    # I
    ...
    .line 3264
    invoke-static {p1}, Lcom/android/server/power/PowerManagerService;->nativeSetInverseColor(I)V
...
.method public systemReady(Lcom/android/server/TwilightService;Lcom/android/server/dreams/DreamManagerService;)V
    ...
    .line 581
    new-instance v19, Landroid/hardware/SystemSensorManager;
    ...
    .line 585
    .local v19, "sensorManager":Landroid/hardware/SensorManager;
    ...
    .line 590
    new-instance v2, Lcom/android/server/power/LenovoPowerMonitor;
    ...
    invoke-direct {v2, v3, v0}, Lcom/android/server/power/LenovoPowerMonitor;-><init>(Landroid/content/Context;Lcom/android/server/power/PowerManagerService;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/power/PowerManagerService;->mPowerMonitor:Lcom/android/server/power/LenovoPowerMonitor;

    .line 591
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/power/PowerManagerService;->mPowerMonitor:Lcom/android/server/power/LenovoPowerMonitor;

    invoke-virtual {v2}, Lcom/android/server/power/LenovoPowerMonitor;->initReceiver()V
    ...
    iget-object v3, v0, Lcom/android/server/power/PowerManagerService;->mPowerMonitor:Lcom/android/server/power/LenovoPowerMonitor;

    invoke-virtual {v2, v3}, Lcom/android/server/power/Notifier;->setPowerMonitor(Lcom/android/server/power/LenovoPowerMonitor;)V
    ...
    .line 607
    new-instance v2, Lcom/android/server/power/PowerManagerService$SmartStandBySettingObserver;
    ...
    invoke-direct {v2, v0, v3}, Lcom/android/server/power/PowerManagerService$SmartStandBySettingObserver;-><init>(Lcom/android/server/power/PowerManagerService;Landroid/os/Handler;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/power/PowerManagerService;->mSmartStandBySettingObserver:Lcom/android/server/power/PowerManagerService$SmartStandBySettingObserver;
    ...
    iget-object v4, v0, Lcom/android/server/power/PowerManagerService;->mSmartStandBySettingObserver:Lcom/android/server/power/PowerManagerService$SmartStandBySettingObserver;
    ...
    .line 773
    invoke-direct/range {p0 .. p0}, Lcom/android/server/power/PowerManagerService;->handleSmartStandBySettingChangedLocked()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/power/PowerManagerService;->isLcdFunctionSupport(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/power/PowerManagerService;->setInverseColor(I)V

    .line 799
    :cond_0
    const-string v2, "persist.sys.screen_saturation"
    ...
    .line 800
    .local v18, "saturationValue":I
    const-string v2, "persist.sys.screen_hue"
    ...
    .line 801
    .local v15, "hueValue":I
    const/16 v2, 0x9

    move/from16 v0, v18

    invoke-static {v2, v0}, Lcom/mediatek/pq/PictureQuality;->setModeCustom(II)V

    .line 802
    move-object/from16 v0, p0

    invoke-virtual {v0, v15}, Lcom/android/server/power/PowerManagerService;->setGammaMode(I)V
    ...
    .line 794
    .end local v15    # "hueValue":I
    .end local v18    # "saturationValue":I
    :cond_1
    const/4 v2, 0x0
    ...
    .end local v19    # "sensorManager":Landroid/hardware/SensorManager;
    :catchall_0
    move-exception v2
...
.method public userActivity(JII)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/power/PowerManagerService;->checkUserActivtyPermission(I)Z
