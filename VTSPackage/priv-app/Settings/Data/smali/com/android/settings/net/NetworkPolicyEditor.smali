...
.method static synthetic access$000(Lcom/android/settings/net/NetworkPolicyEditor;)Landroid/net/NetworkPolicyManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/net/NetworkPolicyEditor;
...
.method public setPolicyMetered(Landroid/net/NetworkTemplate;Z)V
    ...
    const-string v6, "setPolicyMetered "
    ...
    const-string v6, " ,checkbox state = "
    ...
    .line 237
    iput-boolean v7, v1, Landroid/net/NetworkPolicy;->active:Z
    ...
    .line 246
    iput-boolean v8, v1, Landroid/net/NetworkPolicy;->metered:Z

    .line 247
    iput-boolean v7, v1, Landroid/net/NetworkPolicy;->inferred:Z

    .line 249
    iput-boolean v8, v1, Landroid/net/NetworkPolicy;->active:Z
    ...
    const-string v5, "modify wifi policy to update all the policies"
    ...
    .line 266
    iput-boolean v7, v1, Landroid/net/NetworkPolicy;->metered:Z
    ...
    .line 291
    .restart local v2    # "unquoted":Landroid/net/NetworkTemplate;
    .restart local v3    # "unquotedPolicy":Landroid/net/NetworkPolicy;
    :cond_8
    invoke-virtual {p0}, Lcom/android/settings/net/NetworkPolicyEditor;->writeAsync()V
