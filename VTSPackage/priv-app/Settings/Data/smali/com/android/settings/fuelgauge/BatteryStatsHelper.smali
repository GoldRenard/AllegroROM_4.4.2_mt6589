...
.method public startBatteryDetailPage(Landroid/preference/PreferenceActivity;Lcom/android/settings/fuelgauge/BatterySipper;Z)V
    .locals 12
    .param p1, "caller"    # Landroid/preference/PreferenceActivity;
    .param p2, "sipper"    # Lcom/android/settings/fuelgauge/BatterySipper;
    .param p3, "showLocationButton"    # Z
    ...
    iget-wide v3, p2, Lcom/android/settings/fuelgauge/BatterySipper;->usageTime:J
    ...
    invoke-virtual {v2, v0, v9}, Landroid/os/Bundle;->putIntArray(Ljava/lang/String;[I)V
    ...
    .end local v11    # "values":[D
    :pswitch_0
    iget-object v10, p2, Lcom/android/settings/fuelgauge/BatterySipper;->uidObj:Landroid/os/BatteryStats$Uid;
    ...
    iget-wide v3, p2, Lcom/android/settings/fuelgauge/BatterySipper;->cpuTime:J
    ...
    iget-wide v3, p2, Lcom/android/settings/fuelgauge/BatterySipper;->cpuFgTime:J
    ...
    iget-wide v3, p2, Lcom/android/settings/fuelgauge/BatterySipper;->wakeLockTime:J
    ...
    iget-wide v3, p2, Lcom/android/settings/fuelgauge/BatterySipper;->gpsTime:J
    ...
    iget-wide v3, p2, Lcom/android/settings/fuelgauge/BatterySipper;->wifiRunningTime:J
    ...
    iget-wide v3, p2, Lcom/android/settings/fuelgauge/BatterySipper;->mobileRxBytes:J
    ...
    iget-wide v3, p2, Lcom/android/settings/fuelgauge/BatterySipper;->mobileTxBytes:J
    ...
    iget-wide v3, p2, Lcom/android/settings/fuelgauge/BatterySipper;->wifiRxBytes:J
    ...
    iget-wide v3, p2, Lcom/android/settings/fuelgauge/BatterySipper;->wifiTxBytes:J
    ...
    .line 233
    .restart local v11    # "values":[D
    iget-object v0, p2, Lcom/android/settings/fuelgauge/BatterySipper;->drainType:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;
    ...
    .line 235
    .local v8, "result":Ljava/io/Writer;
    ...
    invoke-direct {v7, v8, v0, v1}, Lcom/android/internal/util/FastPrintWriter;-><init>(Ljava/io/Writer;ZI)V
    ...
    iget v3, p0, Lcom/android/settings/fuelgauge/BatteryStatsHelper;->mStatsType:I

    invoke-virtual {v10}, Landroid/os/BatteryStats$Uid;->getUid()I

    move-result v4

    invoke-virtual {v0, v7, v1, v3, v4}, Landroid/os/BatteryStats;->dumpLocked(Ljava/io/PrintWriter;Ljava/lang/String;II)V
    ...
    .end local v8    # "result":Ljava/io/Writer;
    invoke-direct {v8}, Ljava/io/StringWriter;-><init>()V

    .line 241
    .restart local v8    # "result":Ljava/io/Writer;
    new-instance v7, Lcom/android/internal/util/FastPrintWriter;
    ...
    invoke-virtual {v0, v7, v1, v3}, Landroid/os/BatteryStats;->dumpCheckinLocked(Ljava/io/PrintWriter;II)V

    .line 243
    invoke-virtual {v7}, Lcom/android/internal/util/FastPrintWriter;->flush()V

    .line 244
    const-string v0, "report_checkin_details"
