...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lledroid/app/LedroidContextImpl$LedroidServiceFetcher;
    }
.end annotation


# static fields
.field private static final LEDROID_SERVICE_MAP:Ljava/util/HashMap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lledroid/app/LedroidContextImpl;->LEDROID_SERVICE_MAP:Ljava/util/HashMap;
    ...
    invoke-static {v0, v1}, Lledroid/app/LedroidContextImpl;->registerLedroidService(Ljava/lang/String;Lledroid/app/LedroidContextImpl$LedroidServiceFetcher;)V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 17
    iput-object p1, p0, Lledroid/app/LedroidContextImpl;->mContext:Landroid/content/Context;

    .line 18
    return-void
.end method

.method private static registerLedroidService(Ljava/lang/String;Lledroid/app/LedroidContextImpl$LedroidServiceFetcher;)V
    .locals 1
    .param p0, "name"    # Ljava/lang/String;
    .param p1, "fetcher"    # Lledroid/app/LedroidContextImpl$LedroidServiceFetcher;

    .prologue
    .line 74
    sget-object v0, Lledroid/app/LedroidContextImpl;->LEDROID_SERVICE_MAP:Ljava/util/HashMap;
...
.method public getContext()Landroid/content/Context;
    ...
    .prologue
    .line 90
    iget-object v0, p0, Lledroid/app/LedroidContextImpl;->mContext:Landroid/content/Context;
...
.method public getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .prologue
    .line 79
    sget-object v1, Lledroid/app/LedroidContextImpl;->LEDROID_SERVICE_MAP:Ljava/util/HashMap;

    invoke-virtual {v1, p1}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lledroid/app/LedroidContextImpl$LedroidServiceFetcher;

    .line 80
    .local v0, "fetcher":Lledroid/app/LedroidContextImpl$LedroidServiceFetcher;
    if-eqz v0, :cond_0

    iget-object v1, p0, Lledroid/app/LedroidContextImpl;->mContext:Landroid/content/Context;

    invoke-virtual {v0, v1}, Lledroid/app/LedroidContextImpl$LedroidServiceFetcher;->getLedroidService(Landroid/content/Context;)Ljava/lang/Object;
