...
public class SetupWizardActivity extends Activity implements SetupDataCallbacks {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //disableStatusBar();
        mSharedPreferences = getSharedPreferences(SETTINGS_PREFERENCES, Context.MODE_PRIVATE);
    ...
    public void disableStatusBar() {
        mStatusBarManager.disable(StatusBarManager.DISABLE_RECENT | StatusBarManager.DISABLE_HOME | StatusBarManager.DISABLE_SEARCH);
    }
                ...
                if (page == null) {
                    ...
                    switch (page.getId()) {
                        case R.string.setup_google_account:
                            if (accountExists(ACCOUNT_TYPE_GOOGLE)) {
    ...
    private void removeUnNeededPages() {
        ...
        if (page != null && accountExists(ACCOUNT_TYPE_GOOGLE)) {
    ...
    private void doSimCheck() {
        if (!mSharedPreferences.getBoolean(KEY_SIM_MISSING_SHOWN, false)) {
            if (isGSMPhone(SetupWizardActivity.this) && isSimMissing(SetupWizardActivity.this)) {
    ...
    public void launchGoogleAccountSetup() {
        ...
        bundle.putBoolean(EXTRA_FIRST_RUN, true);
        bundle.putBoolean(EXTRA_ALLOW_SKIP, true);
        AccountManager.get(this).addAccount(ACCOUNT_TYPE_GOOGLE, null, null, bundle, this, new AccountManagerCallback<Bundle>() {
            @Override
