...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSelectedColor = res.getColor(mThemeDark? R.color.red_dtpicker : R.color.blue);
        mUnselectedColor = res.getColor(mThemeDark? R.color.white_dtpicker : R.color.numbers_text_color);
        ...
        int white = res.getColor(R.color.white_dtpicker);
