...
public class AmPmCirclesView extends View {
    ...
    public void initialize(Context context, int amOrPm) {
        ...
        mUnselectedColor = res.getColor(R.color.white_dtpicker);
        mSelectedColor = res.getColor(R.color.blue);
        mAmPmTextColor = res.getColor(R.color.ampm_text_color_dtpicker);
    ...
    /* package */ void setTheme(Context context, boolean themeDark) {
        ...
        if (themeDark) {
            ...
            mSelectedColor = res.getColor(R.color.red_dtpicker);
            mAmPmTextColor = res.getColor(R.color.white_dtpicker);
