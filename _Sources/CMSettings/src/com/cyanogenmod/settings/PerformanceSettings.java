...
public class PerformanceSettings extends SettingsPreferenceFragment implements
    ...
    private static final String SCREEN_RESOLUTION_PREF = "pref_screen_res";
	...
	private static String SCREEN_RESOLUTION_PERSIST = "screen_resolution";
    
    private ListPreference mPerfProfilePref;
    private ListPreference mScreenResPref;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mScreenResPref = (ListPreference) prefSet.findPreference(SCREEN_RESOLUTION_PREF);
        String defScreenRes = Settings.Secure.getString(getContentResolver(), SCREEN_RESOLUTION_PERSIST);
        mScreenResPref.setValue(defScreenRes == null ? getString(R.string.config_screenres_native) : defScreenRes);
        mScreenResPref.setOnPreferenceChangeListener(this);
    ...
    public void onResume() {
        ...
        /*if (mPerfProfilePref != null) {
            ...
            resolver.registerContentObserver(Settings.Secure.getUriFor(
                    SettingsWrapper.Secure.PERFORMANCE_PROFILE), false, mPerformanceProfileObserver);
        }*/
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mUse16bppAlphaPref) {
        	if (RootUtils.shouldSU()) {
        		RootUtils.setProp(USE_16BPP_ALPHA_PROP,
        	...
        	if (RootUtils.shouldSU()) {
        		RootUtils.setProp(FORCE_HIGHEND_GFX_PERSIST_PROP,
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (newValue != null) {
        	 if (preference == mScreenResPref) { 
        		 String newValueStr = (String)newValue;
        		 Settings.Secure.putString(getContentResolver(), SCREEN_RESOLUTION_PERSIST, newValueStr);
        		 ScreenUtils.setDisplayDensityProp(newValueStr.split("\\|")[1]);
        		 return true;
             }
