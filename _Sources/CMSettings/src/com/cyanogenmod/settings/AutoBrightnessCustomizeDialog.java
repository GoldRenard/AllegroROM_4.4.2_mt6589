...
import com.cyanogenmod.settings.widget.CubicSplinePreviewView;
...
public class AutoBrightnessCustomizeDialog extends AlertDialog
    ...
    private void updateSettings(boolean forceDefault) {
        ...
        if (!forceDefault) {
            lux = fetchItems(SettingsWrapper.System.AUTO_BRIGHTNESS_LUX);
            values = fetchItems(SettingsWrapper.System.AUTO_BRIGHTNESS_BACKLIGHT);
        }
    ...
    private void putSettings() {
        ...
        putItems(SettingsWrapper.System.AUTO_BRIGHTNESS_LUX, lux);
        putItems(SettingsWrapper.System.AUTO_BRIGHTNESS_BACKLIGHT, values);
    }
