...
public class LockscreenButtons extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMenuUnlock = (CheckBoxPreference)
                findPreference(SettingsWrapper.System.MENU_UNLOCK_SCREEN);
        mHomeUnlock = (CheckBoxPreference)
                findPreference(SettingsWrapper.System.HOME_UNLOCK_SCREEN);
        mCameraUnlock = (CheckBoxPreference)
                findPreference(SettingsWrapper.System.CAMERA_UNLOCK_SCREEN);
        ...
        if (hasBackKey) {
            mLongBackAction.setKey(SettingsWrapper.System.LOCKSCREEN_LONG_BACK_ACTION);
        } else {
        ...
        if (hasHomeKey) {
            mLongHomeAction.setKey(SettingsWrapper.System.LOCKSCREEN_LONG_HOME_ACTION);
        } else {
        ...
        if (hasMenuKey) {
            mLongMenuAction.setKey(SettingsWrapper.System.LOCKSCREEN_LONG_MENU_ACTION);
        } else {
    ...
    private void updateUnlockButtonTypes() {
        ...
        boolean customKeyguardEnabled = Settings.System.getInt(
                ...
                SettingsWrapper.System.LOCKSCREEN_MODLOCK_ENABLED, 1) == 1;
