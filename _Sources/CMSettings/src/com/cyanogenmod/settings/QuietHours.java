...
public class QuietHours extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mQuietHoursTimeRange.setTimeRange(
                Settings.System.getInt(resolver, SettingsWrapper.System.QUIET_HOURS_START, 0),
                Settings.System.getInt(resolver, SettingsWrapper.System.QUIET_HOURS_END, 0));
        ...
        if (telephonyManager.getPhoneType() == TelephonyManager.PHONE_TYPE_NONE) {
            ...
            int muteType = Settings.System.getInt(resolver, SettingsWrapper.System.QUIET_HOURS_RINGER, 0);
        ...
        if (!res.getBoolean(com.android.internal.R.bool.config_intrusiveNotificationLed)) {
            removePreference(SettingsWrapper.System.QUIET_HOURS_DIM);
        }

        // Remove the vibrator dependent settings if the device does not have a vibrator
        Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
        if (vibrator == null || !vibrator.hasVibrator()) {
               removePreference(SettingsWrapper.System.QUIET_HOURS_STILL);
               removePreference(SettingsWrapper.System.QUIET_HOURS_HAPTIC);
        }
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mQuietHoursTimeRange) {
            Settings.System.putInt(resolver, SettingsWrapper.System.QUIET_HOURS_START,
                    mQuietHoursTimeRange.getStartTime());
            Settings.System.putInt(resolver, SettingsWrapper.System.QUIET_HOURS_END,
            ...
            Settings.System.putInt(resolver, SettingsWrapper.System.QUIET_HOURS_RINGER, ringerMuteType);
