...
public class SystemUiSettings extends SettingsPreferenceFragment  implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!Utils.hideUnsupportedFeatures()) {
	        ...
	        //SettingsWrapper.System.EXPANDED_DESKTOP_SYSTEM_BARS_VISIBILITY
	        // Navigation bar left
	        mNavigationBarLeftPref = (CheckBoxPreference) findPreference(KEY_NAVIGATION_BAR_LEFT);
	
	        int expandedDesktopValue = Settings.System.getInt(getContentResolver(),
	                SettingsWrapper.System.EXPANDED_DESKTOP_STYLE, 0);
	        ...
	        try {
	            ...
	            boolean forceNavbar = android.provider.Settings.System.getInt(getContentResolver(),
	            		SettingsWrapper.System.DEV_FORCE_SHOW_NAVBAR, 0) == 1;
        	...
        	prefScreen.removePreference(expandedCategory);
        	...
        	try {
	            ...
	            if (hasNavBar) {
	            	// left position not supported
	            	PreferenceCategory navCategory =
                            (PreferenceCategory) findPreference(CATEGORY_NAVBAR);
                    navCategory.removePreference(findPreference(KEY_NAVIGATION_BAR_LEFT));
	            } else {
	                // Hide navigation bar category
	                prefScreen.removePreference(findPreference(CATEGORY_NAVBAR));
	            }
    ...
    private void updateExpandedDesktop(int value) {
        ...
        Settings.System.putInt(cr, SettingsWrapper.System.EXPANDED_DESKTOP_STYLE, value);

        if (value == 0) {
            // Expanded desktop deactivated
            Settings.System.putInt(cr, SettingsWrapper.System.POWER_MENU_EXPANDED_DESKTOP_ENABLED, 0);
            Settings.System.putInt(cr, SettingsWrapper.System.EXPANDED_DESKTOP_STATE, 0);
            summary = R.string.expanded_desktop_disabled;
        } else if (value == 1) {
            Settings.System.putInt(cr, SettingsWrapper.System.POWER_MENU_EXPANDED_DESKTOP_ENABLED, 1);
