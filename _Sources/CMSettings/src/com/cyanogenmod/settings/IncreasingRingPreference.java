...
public class IncreasingRingPreference extends VolumePreference implements
    ...
    protected void onBindDialogView(View view) {
        ...
        mEnabledCheckbox.setChecked(Settings.System.getInt(cr, SettingsWrapper.System.INCREASING_RING, 0) == 1);
        mMinVolumeSeekBar.setProgress(Settings.System.getInt(
                    cr, SettingsWrapper.System.INCREASING_RING_MIN_VOLUME, 1));
        int interval = Settings.System.getInt(cr, SettingsWrapper.System.INCREASING_RING_INTERVAL, 0);
        int index = 0;
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        if (positiveResult) {
            ...
            Settings.System.putInt(cr, SettingsWrapper.System.INCREASING_RING, checked ? 1 : 0);
            Settings.System.putInt(cr, SettingsWrapper.System.INCREASING_RING_INTERVAL,
                    mIntervalValues[mInterval.getSelectedItemPosition()]);
            Settings.System.putInt(cr,
            		SettingsWrapper.System.INCREASING_RING_MIN_VOLUME,
