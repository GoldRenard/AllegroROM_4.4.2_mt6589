...
import com.cyanogenmod.settings.ButtonSettings;
import com.cyanogenmod.settings.LockscreenInterface;
import com.cyanogenmod.settings.SystemUiSettings;
...
*/
     ...
     */
    public static class LockscreenSettingsActivity extends SubSettings { /* empty */ }
    public static class SystemSettingsActivity extends SubSettings { /* empty */ }
    public static class QuickSettingsConfigActivity extends SubSettings { /* empty */ }
    public static class QuietHoursSettingsActivity extends SubSettings { /* empty */ }
    public static class ProcessorSettingsActivity extends SubSettings { /* empty */ }
    public static class ButtonSettingsActivity extends SubSettings { /* empty */ }
    public static class PerformanceSettingsActivity extends SubSettings { /* empty */ }
}
