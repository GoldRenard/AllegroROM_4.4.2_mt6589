...
public class StatusBar extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CheckBoxPreference statusBarBrightnessControl = (CheckBoxPreference)
                prefSet.findPreference(SettingsWrapper.System.STATUS_BAR_BRIGHTNESS_CONTROL);
        ...
        int batteryStyle = Settings.System.getInt(resolver, SettingsWrapper.System.STATUS_BAR_BATTERY, 0);
        mStatusBarBattery.setValue(String.valueOf(batteryStyle));
        mStatusBarBattery.setSummary(mStatusBarBattery.getEntry());
        mStatusBarBattery.setOnPreferenceChangeListener(this);

        int signalStyle = Settings.System.getInt(resolver, SettingsWrapper.System.STATUS_BAR_SIGNAL_TEXT, 0);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mStatusBarBattery) {
            ...
            Settings.System.putInt(resolver, SettingsWrapper.System.STATUS_BAR_BATTERY, batteryStyle);
            ...
            Settings.System.putInt(resolver, SettingsWrapper.System.STATUS_BAR_SIGNAL_TEXT, signalStyle);
