...
public class AutoBrightnessSetup extends AlertActivity implements
    ...
    protected void onStart() {
        ...
        float currentSensitivity = Settings.System.getFloat(resolver,
                SettingsWrapper.System.AUTO_BRIGHTNESS_RESPONSIVENESS, 1.0f);
        ...
        mTwilightAdjustment.setChecked(Settings.System.getInt(resolver,
        		SettingsWrapper.System.AUTO_BRIGHTNESS_TWILIGHT_ADJUSTMENT, 0) != 0);
    }
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (selection >= 0) {
            ...
            Settings.System.putFloat(resolver,
            		SettingsWrapper.System.AUTO_BRIGHTNESS_RESPONSIVENESS, sensitivity);
        }
        ...
        Settings.System.putInt(resolver,
        		SettingsWrapper.System.AUTO_BRIGHTNESS_TWILIGHT_ADJUSTMENT,
