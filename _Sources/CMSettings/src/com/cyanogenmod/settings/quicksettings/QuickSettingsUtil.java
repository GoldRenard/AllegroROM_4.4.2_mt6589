...
package com.cyanogenmod.settings.quicksettings;

import static com.goldrenard.internal.util.cm.QSConstants.TILES_DEFAULT;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_AIRPLANE;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_AUTOROTATE;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_BATTERY;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_BLUETOOTH;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_BRIGHTNESS;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_CAMERA;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_DELIMITER;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_EXPANDEDDESKTOP;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_GPS;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_LOCKSCREEN;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_LTE;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_MOBILEDATA;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_NETWORKADB;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_NETWORKMODE;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_NFC;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_PROFILE;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_PERFORMANCE_PROFILE;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_QUIETHOURS;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_RINGER;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_SCREENTIMEOUT;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_SETTINGS;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_SLEEP;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_SYNC;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_TORCH;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_USER;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_VOLUME;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_WIFI;
import static com.goldrenard.internal.util.cm.QSConstants.TILE_WIFIAP;
...
public class QuickSettingsUtil {
    ...
    protected static synchronized void removeUnsupportedTiles(Context context) {
    	...
    	if (Utils.hideUnsupportedFeatures()) {
    		removeTile(TILE_PERFORMANCE_PROFILE);
    		removeTile(TILE_PROFILE);
    		removeTile(TILE_QUIETHOURS);
    		//removeTile(TILE_NETWORKADB);
    		removeTile(TILE_EXPANDEDDESKTOP);
    	}
    }
    ...
    public static String getCurrentTiles(Context context, boolean isRibbon) {
        String tiles = Settings.System.getString(context.getContentResolver(),
                isRibbon ? SettingsWrapper.System.QUICK_SETTINGS_RIBBON_TILES
                         : SettingsWrapper.System.QUICK_SETTINGS_TILES);
        if (tiles == null) {
    ...
    public static void saveCurrentTiles(Context context, String tiles, boolean isRibbon) {
        Settings.System.putString(context.getContentResolver(),
                isRibbon ? SettingsWrapper.System.QUICK_SETTINGS_RIBBON_TILES
                         : SettingsWrapper.System.QUICK_SETTINGS_TILES, tiles);
    }
    ...
    public static void resetTiles(Context context, boolean isRibbon) {
        ...
        Settings.System.putString(context.getContentResolver(),
                isRibbon ? SettingsWrapper.System.QUICK_SETTINGS_RIBBON_TILES
                         : SettingsWrapper.System.QUICK_SETTINGS_TILES, defaultTiles);
    }
