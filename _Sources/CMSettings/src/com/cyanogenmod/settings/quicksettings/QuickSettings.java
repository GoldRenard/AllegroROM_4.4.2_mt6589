...
import com.goldrenard.internal.util.cm.QSConstants;
...
public class QuickSettings extends SettingsPreferenceFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (!Utils.isPhone(getActivity())) {
            ...
            int quickPulldownValue = Settings.System.getInt(resolver,
                    SettingsWrapper.System.QS_QUICK_PULLDOWN, 0);
        ...
        if (vibrator.hasVibrator()) {
            String storedRingMode = Settings.System.getString(resolver,
            		SettingsWrapper.System.EXPANDED_RING_MODE);
        ...
        if (!QSUtils.deviceSupportsDockBattery(getActivity())) {
            Preference pref = findPreference(SettingsWrapper.System.QS_DYNAMIC_DOCK_BATTERY);
            if (pref != null) {
                mDynamicTiles.removePreference(pref);
            }
        }
        if (!QSUtils.deviceSupportsImeSwitcher(getActivity())) {
            Preference pref = findPreference(SettingsWrapper.System.QS_DYNAMIC_IME);
            if (pref != null) {
                mDynamicTiles.removePreference(pref);
            }
        }
        if (!QSUtils.deviceSupportsUsbTether(getActivity())) {
            Preference pref = findPreference(SettingsWrapper.System.QS_DYNAMIC_USBTETHER);
            if (pref != null) {
                mDynamicTiles.removePreference(pref);
            }
        }
        if (!QSUtils.deviceSupportsWifiDisplay(getActivity())) {
            Preference pref = findPreference(SettingsWrapper.System.QS_DYNAMIC_WIFI);
            if (pref != null) {
                mDynamicTiles.removePreference(pref);
            }
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mRingMode) {
            ...
            Settings.System.putString(resolver, SettingsWrapper.System.EXPANDED_RING_MODE, value);
            ...
            Settings.System.putInt(resolver, SettingsWrapper.System.EXPANDED_NETWORK_MODE, value);
            mNetworkMode.setSummary(mNetworkMode.getEntries()[index]);
            return true;
        } else if (preference == mQuickPulldown) {
            int quickPulldownValue = Integer.valueOf((String) newValue);
            Settings.System.putInt(resolver, SettingsWrapper.System.QS_QUICK_PULLDOWN,
                    quickPulldownValue);
            updatePulldownSummary(quickPulldownValue);
            return true;
            ...
            Settings.System.putInt(resolver, SettingsWrapper.System.EXPANDED_SCREENTIMEOUT_MODE, value);
