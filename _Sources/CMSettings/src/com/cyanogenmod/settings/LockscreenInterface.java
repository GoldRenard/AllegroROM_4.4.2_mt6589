...
import com.goldrenard.internal.widget.LockPatternUtils;
import com.cyanogenmod.settings.ChooseLockSettingsHelper;
...
public class LockscreenInterface extends SettingsPreferenceFragment implements
    ...
    private Preference mScreenSecurity;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final String keyguardPackage = getActivity().getString(R.string.config_keyguardPackage);
        ...
        mScreenSecurity = findPreference(KEY_SCREEN_SECURITY);
        if (mScreenSecurity != null) {
        	mScreenSecurity.setOnPreferenceClickListener(new OnPreferenceClickListener() {
				@Override
    ...
    public void onResume() {
        ...
        if (mBatteryStatus != null) {
            ...
            int batteryStatus = Settings.System.getInt(cr,
                    SettingsWrapper.System.LOCKSCREEN_BATTERY_VISIBILITY, 0);
        ...
        if (mEnableModLock != null) {
            ...
            boolean checked = Settings.System.getInt(
                    cr, SettingsWrapper.System.LOCKSCREEN_MODLOCK_ENABLED, 1) == 1;
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mBatteryStatus) {
            ...
            Settings.System.putInt(cr, SettingsWrapper.System.LOCKSCREEN_BATTERY_VISIBILITY, value);
            mBatteryStatus.setSummary(mBatteryStatus.getEntries()[index]);
            return true;
        } else if (preference == mEnableModLock) {
            boolean value = (Boolean) objValue;
            Settings.System.putInt(cr, SettingsWrapper.System.LOCKSCREEN_MODLOCK_ENABLED,
                    value ? 1 : 0);
    ...
    public boolean hasButtons() {
        return (getResources().getInteger(R.integer.config_deviceHardwareKeys) > 0);
    }
