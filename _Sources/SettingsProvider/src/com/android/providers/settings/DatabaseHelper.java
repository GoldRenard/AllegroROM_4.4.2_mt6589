...
public class DatabaseHelper extends SQLiteOpenHelper
{
  ...
  private static final String defaultEnableInputMethods = "com.android.inputmethod.latin/.LatinIME:com.baidu.input/.ImeService";
  ...
  public static IDatabaseHelperExt getDatabaseHelperPlgin(Context paramContext)
  {
    try
    {
      Log.d("SettingsProvider", "getDatabaseHelperPlgin() --- begin");
      IDatabaseHelperExt localIDatabaseHelperExt = (IDatabaseHelperExt)PluginManager.createPluginObject(paramContext, IDatabaseHelperExt.class.getName(), new Signature[0]);
      Log.d("SettingsProvider", "getDatabaseHelperPlgin() --- end: " + localIDatabaseHelperExt);
      return localIDatabaseHelperExt;
    }
    catch (Plugin.ObjectCreationException localObjectCreationException)
    {
  ...
  private void loadGlobalSettings(SQLiteDatabase db) {
      ...
      try {
          ...
          loadBooleanSetting(stmt, Settings.Global.AUTO_TIME_GPS, 
        		  R.bool.def_auto_time_gps);
          
          
          String auto_time = this.mExt.getResBoolean(this.mContext, Settings.Global.AUTO_TIME,
                  R.bool.def_auto_time);
          if (auto_time == null) {
              loadBooleanSetting(stmt, Settings.Global.AUTO_TIME,
                      R.bool.def_auto_time); // Sync time to NITZ
          } else {
        	  loadSetting(stmt, Settings.Global.AUTO_TIME, auto_time);
          }
          
          String auto_time_zone = this.mExt.getResBoolean(this.mContext, Settings.Global.AUTO_TIME_ZONE, 
        		  R.bool.def_auto_time_zone);
          if (auto_time_zone == null) {
              loadBooleanSetting(stmt, Settings.Global.AUTO_TIME_ZONE,
                      R.bool.def_auto_time_zone); // Sync timezone to NITZ
          } else {
        	  loadSetting(stmt, Settings.Global.AUTO_TIME_ZONE, auto_time_zone);
          }
          ...
          String wifi_sleep_policy = this.mExt.getResInteger(this.mContext, Settings.Global.WIFI_SLEEP_POLICY,
                  R.integer.def_wifi_sleep_policy);
          if (wifi_sleep_policy == null) {
        	  loadIntegerSetting(stmt, Settings.Global.WIFI_SLEEP_POLICY,
                      R.integer.def_wifi_sleep_policy);
          } else {
        	  loadSetting(stmt, Settings.Global.WIFI_SLEEP_POLICY, wifi_sleep_policy);
          }
          ...
          String install_non_market_apps = this.mExt.getResBoolean(this.mContext, Settings.Global.INSTALL_NON_MARKET_APPS,
                  R.bool.def_install_non_market_apps);
          if (install_non_market_apps == null) {
        	  loadBooleanSetting(stmt, Settings.Global.INSTALL_NON_MARKET_APPS,
                      R.bool.def_install_non_market_apps);
          } else {
        	  loadSetting(stmt, Settings.Global.INSTALL_NON_MARKET_APPS, install_non_market_apps);
          }
          ...
          loadSetting(stmt, Settings.Global.DATA_ROAMING_2, 
        		  Integer.valueOf(SystemProperties.get("ro.com.android.dataroaming2", String.valueOf(false)) == "true" ? "1" : "0"));
  ...
  private void loadSecureSettings(SQLiteDatabase db) {
      ...
      try {
          ...
          String location_providers_allowed = this.mExt.getResStr(this.mContext, "location_providers_allowed", 2131099650);
          if (location_providers_allowed == null) {
        	  loadStringSetting(stmt, Settings.Secure.LOCATION_PROVIDERS_ALLOWED,
                      R.string.def_location_providers_allowed);
          } else {
        	  loadSetting(stmt, Settings.Secure.LOCATION_PROVIDERS_ALLOWED, location_providers_allowed);
          }
          ...
          String battery_percentage = this.mExt.getResBoolean(this.mContext, Settings.Secure.BATTERY_PERCENTAGE, 
        		  R.bool.def_battery_percentage);
          if (battery_percentage != null) {
        	  loadSetting(stmt, Settings.Secure.BATTERY_PERCENTAGE, battery_percentage);
          } else {
  ...
  private void loadSettings(SQLiteDatabase db) {
	  this.mExt = getDatabaseHelperPlgin(this.mContext);
  ...
  private void loadStringSetting(SQLiteStatement stmt, String key, int resid) {
	...
	private void loadCyanogenSettings(SQLiteStatement stmt) {
		String tiles = mContext.getResources().getString(R.string.def_quick_settings_ribbon_tiles);
		if (!TextUtils.isEmpty(tiles)) {
		    loadSetting(stmt, "qs_quick_access", "1");
		    loadSetting(stmt, "qs_quick_access_linked", "0");
		    loadSetting(stmt, "quick_settings_ribbon_tiles", tiles);
		}
		
        // Set default noise suppression value
        loadBooleanSetting(stmt, "noise_suppression", R.bool.def_noise_suppression);
        
        loadIntegerSetting(stmt, "status_bar_battery", R.integer.def_battery_style);
        
        loadIntegerSetting(stmt, "status_bar_battery_show_percent", R.integer.def_battery_show_percent);
        
        loadIntegerSetting(stmt, "status_bar_notif_count", R.integer.def_notif_count);
        
        loadIntegerSetting(stmt, "qs_quick_pulldown", R.integer.def_qs_quick_pulldown);
        
        if (mContext.getResources()
                .getBoolean(com.android.internal.R.bool.config_voice_capable)) {
            loadStringSetting(stmt, "lockscreen_targets", R.string.def_lockscreen_targets);
        } else {
            loadStringSetting(stmt, "lockscreen_targets", R.string.def_lockscreen_targets_no_telephony);
        }
        
        loadIntegerSetting(stmt, "dev_force_show_navbar", R.integer.def_force_disable_navkeys);
        
        loadIntegerSetting(stmt, "double_tap_sleep_gesture", R.integer.def_double_tap_sleep_gesture);
	}
  ...
  private void loadSystemSettings(SQLiteDatabase db) {
      ...
      try {
          ...
          loadSetting(stmt, Settings.System.TOTAL_WIDE_TOUCH, 
        		  Settings.System.TOTAL_WIDE_TOUCH_DEFAULT);
          loadSetting(stmt, Settings.System.FLOAT_BUTTON, 
        		  Settings.System.FLOAT_BUTTON_DEFAULT);
          loadSetting(stmt, Settings.System.WIDE_TOUCH, 
        		  Settings.System.WIDE_TOUCH_DEFAULT);
          loadSetting(stmt, Settings.System.WIDE_TOUCH_AREA_SETTING, 
        		  120);
          
          loadSetting(stmt, Settings.System.SIDE_KEY_BACKLIGHT,
        		  Settings.System.SIDE_KEY_BACKLIGHT_DEFAULT);
          
          loadBooleanSetting(stmt, Settings.System.SCREEN_BRIGHTNESS_MODE,
                  R.bool.def_screen_brightness_automatic_mode);
          loadIntegerSetting(stmt, Settings.System.BUTTON_BRIGHTNESS_MODE, 
        		  R.integer.def_button_brightness);
          ...
          loadCyanogenSettings(stmt);
          
          loadStringSetting(stmt, "mtk_audioprofile_active", R.string.def_active_profile);
          loadSetting(stmt, Settings.System.DUAL_SIM_MODE_SETTING, 1);
          loadIntegerSetting(stmt, Settings.System.BOOT_UP_SELECT_MODE, R.integer.boot_up_select_mode);
          loadSetting(stmt, Settings.System.ENABLE_INTERNET_CALL, 0);
          loadSetting(stmt, Settings.System.ROAMING_REMINDER_MODE_SETTING, 1);
          loadBooleanSetting(stmt, Settings.System.ROAMING_INDICATION_NEEDED, R.bool.def_roaming_indicate_needed);
          loadBooleanSetting(stmt, Settings.System.IPO_SETTING, R.bool.def_ipo_setting);
          loadStringSetting(stmt, Settings.System.LANDSCAPE_LAUNCHER, R.string.def_landscape_launcher);
          loadIntegerSetting(stmt, Settings.System.WIFI_SELECT_SSID_TYPE, R.integer.wifi_select_ssid_type);
          loadStringSetting(stmt, Settings.System.MTK_RTSP_NAME, R.string.mtk_rtsp_name);
          loadStringSetting(stmt, Settings.System.MTK_RTSP_TO_PROXY, R.string.mtk_rtsp_to_proxy);
          loadStringSetting(stmt, Settings.System.MTK_RTSP_NETINFO, R.string.mtk_rtsp_netinfo);
          loadStringSetting(stmt, Settings.System.MTK_RTSP_TO_NAPID, R.string.mtk_rtsp_to_napid);
          loadStringSetting(stmt, Settings.System.MTK_RTSP_MAX_UDP_PORT, R.string.mtk_rtsp_max_udp_port);
          loadStringSetting(stmt, Settings.System.MTK_RTSP_MIN_UDP_PORT, R.string.mtk_rtsp_min_udp_port);
          loadIntegerSetting(stmt, Settings.System.VOICE_CALL_REJECT_MODE, R.integer.def_voice_call_reject_mode);
          loadIntegerSetting(stmt, Settings.System.VT_CALL_REJECT_MODE, R.integer.def_video_call_reject_mode);
          loadIntegerSetting(stmt, Settings.System.IVSR_SETTING, R.integer.def_ivsr_setting);
          loadIntegerSetting(stmt, Settings.System.CRO_SETTING, R.integer.def_cro_setting);
          loadIntegerSetting(stmt, Settings.System.HOO_SETTING, R.integer.def_hoo_setting);
          loadIntegerSetting(stmt, Settings.System.TETHER_IPV6_FEATURE, R.integer.def_tether_ipv6_feature);
          ...
          loadBooleanSetting(stmt, Settings.System.ESURFING_DIALING, R.bool.def_eSurfing_dialing);
          loadIntegerSetting(stmt, Settings.System.INTER_DIAL_SETTING, R.integer.def_international_dialing);
          loadBooleanSetting(stmt, Settings.System.DATAUSAGE_ON_LOCKSCREEN_SIM1, R.bool.data_usage_on_lockscreen);
          loadBooleanSetting(stmt, Settings.System.DATAUSAGE_ON_LOCKSCREEN_SIM2, R.bool.data_usage_on_lockscreen);
          loadSetting(stmt, Settings.System.DTMF_TONE_WHEN_DIALING, 1);
          loadSetting(stmt, Settings.System.SCREEN_SMART_ROTATION, 3);
          loadSetting(stmt, Settings.System.GPRS_CONNECTION_SETTING, -4);
          loadSetting(stmt, Settings.System.FACTORY_DEVICE_PROVISIONED, 0);
          loadIntegerSetting(stmt, Settings.System.HDMI_ENABLE_STATUS, R.integer.def_hdmi_enable_status);
          loadIntegerSetting(stmt, Settings.System.HDMI_VIDEO_RESOLUTION, R.integer.def_hdmi_video_resolution);
          loadIntegerSetting(stmt, Settings.System.HDMI_VIDEO_SCALE, R.integer.def_hdmi_video_scale);
          loadIntegerSetting(stmt, Settings.System.HDMI_COLOR_SPACE, R.integer.def_hdmi_color_space);
          loadIntegerSetting(stmt, Settings.System.HDMI_DEEP_COLOR, R.integer.def_hdmi_deep_color);
          loadIntegerSetting(stmt, Settings.System.HDMI_CABLE_PLUGGED, R.integer.def_hdmi_cable_plugged);
          ...
          loadBooleanSetting(stmt, Settings.System.CHANGE_POINTER_PRIMARY_KEY, R.bool.def_change_pointer_primary_key);
          loadIntegerSetting(stmt, Settings.System.POINTER_DOUBLE_CLICK_SPEED, R.integer.def_double_click_speed);
          loadIntegerSetting(stmt, Settings.System.BG_POWER_SAVING_ENABLE, R.integer.def_bg_power_saving);
          loadIntegerSetting(stmt, Settings.System.DISABLE_AAL, R.integer.disable_aal);
  ...
  private void loadUISoundEffectsSettings(SQLiteStatement stmt)
  {
      ...
      String haptic_feedback_enabled = this.mExt.getResBoolean(this.mContext, Settings.System.HAPTIC_FEEDBACK_ENABLED, 
    		  R.bool.def_haptic_feedback);
      if (haptic_feedback_enabled != null) {
    	  loadSetting(stmt, "haptic_feedback_enabled", haptic_feedback_enabled);
      } else {
          loadBooleanSetting(stmt, Settings.System.HAPTIC_FEEDBACK_ENABLED,
                  R.bool.def_haptic_feedback);
      }
  ...
  public void onUpgrade(SQLiteDatabase db, int oldVersion, int currentVersion) {
     ...
     if (upgradeVersion == 51) {
         ...
         String[] settingsToMove = {
                 ...
                 "lock_pattern_size",
                 "lock_pattern_dotsvisible",
                 "lock_pattern_show_error_path",
...
/* Location:           C:\Users\Renard\Desktop\123.jar
