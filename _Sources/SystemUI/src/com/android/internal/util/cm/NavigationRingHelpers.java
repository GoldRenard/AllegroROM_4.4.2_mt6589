...
import static com.goldrenard.internal.util.cm.NavigationRingConstants.*;

import com.goldrenard.internal.util.cm.SettingsWrapper;
import com.goldrenard.internal.util.cm.TorchConstants;
import com.goldrenard.internal.widget.multiwaveview.GlowPadView;
import com.goldrenard.internal.widget.multiwaveview.TargetDrawable;
...
public class NavigationRingHelpers {
    ...
    public static String[] getTargetActions(Context context) {
        ...
        for (int i = 0; i < MAX_ACTIONS; i++) {
            result[i] = Settings.System.getString(cr, SettingsWrapper.System.NAVIGATION_RING_TARGETS[i]);
            if (result[i] != null) {
                isDefault = false;
            }
        }
    ...
    public static void resetActionsToDefaults(Context context) {
        final ContentResolver cr = context.getContentResolver();
        Settings.System.putString(cr, SettingsWrapper.System.NAVIGATION_RING_TARGETS[0], null);
        Settings.System.putString(cr, SettingsWrapper.System.NAVIGATION_RING_TARGETS[1], ACTION_ASSIST);
        Settings.System.putString(cr, SettingsWrapper.System.NAVIGATION_RING_TARGETS[2], null);
    }
    ...
    public static TargetDrawable getTargetDrawable(Context context, String action) {
        ...
        if (TextUtils.isEmpty(action) || action.equals(ACTION_NONE)) {
            ...
            resourceId = R.drawable.ic_action_assist_generic;
        }
        ...
        if (resourceId == R.drawable.ic_navigation_ring_empty) {
    ...
    private static TargetDrawable createDrawableForActivity(Resources res, Drawable activityIcon) {
        Drawable iconBg = res.getDrawable(
                R.drawable.ic_navigation_ring_blank_normal);
        Drawable iconBgActivated = res.getDrawable(
                R.drawable.ic_navigation_ring_blank_activated);
