...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    SettingsWrapper.System.STATUS_BAR_COLLAPSE_ON_DISMISS), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
            		SettingsWrapper.System.EXPANDED_DESKTOP_STATE), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
            		SettingsWrapper.System.EXPANDED_DESKTOP_STYLE), false, this);
            update();
        }
        ...
        private void update() {
            ...
            mAutoCollapseBehaviour = Settings.System.getIntForUser(resolver,
            		SettingsWrapper.System.STATUS_BAR_COLLAPSE_ON_DISMISS,
                    SettingsWrapper.System.STATUS_BAR_COLLAPSE_IF_NO_CLEARABLE, UserHandle.USER_CURRENT);
            mExpandedDesktopStyle = 0;
            if (Settings.System.getIntForUser(resolver,
            		SettingsWrapper.System.EXPANDED_DESKTOP_STATE, 0, UserHandle.USER_CURRENT) != 0) {
                mExpandedDesktopStyle = Settings.System.getIntForUser(mContext.getContentResolver(),
                		SettingsWrapper.System.EXPANDED_DESKTOP_STYLE, 0, UserHandle.USER_CURRENT);
            }
        }
    };
        ...
        return new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if (Settings.Secure.getInt(cr,
                		SettingsWrapper.Secure.DEVELOPMENT_SHORTCUT, 0) == 0) {
                    mNotificationBlamePopup.getMenu()
    ...
    protected void maybeCollapseAfterNotificationRemoval(boolean userDismissed) {
        if (mAutoCollapseBehaviour == SettingsWrapper.System.STATUS_BAR_COLLAPSE_NEVER) {
            return;
        }
        ...
        boolean collapseDueToEmpty =
                mAutoCollapseBehaviour == SettingsWrapper.System.STATUS_BAR_COLLAPSE_IF_EMPTIED
                && mNotificationData.size() == 0;
        boolean collapseDueToNoClearable =
                mAutoCollapseBehaviour == SettingsWrapper.System.STATUS_BAR_COLLAPSE_IF_NO_CLEARABLE
