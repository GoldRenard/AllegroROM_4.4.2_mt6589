...
import static com.goldrenard.internal.util.cm.QSConstants.*;
...
public class QuickSettingsController {
    ...
    void loadTiles() {
        ...
        for (String tile : tiles.split("\\|")) {
            ...
            if (tile.equals(TILE_USER)) {
                ...
                mTileStatusUris.add(Settings.System.getUriFor(SettingsWrapper.System.SYSTEM_PROFILES_ENABLED));
                ...
                mTileStatusUris.add(Settings.System.getUriFor(SettingsWrapper.System.EXPANDED_DESKTOP_STYLE));
        ...
        if (Settings.System.getIntForUser(resolver,
        		SettingsWrapper.System.QS_DYNAMIC_ALARM, 1, UserHandle.USER_CURRENT) == 1) {
            QuickSettingsTile qs = new AlarmTile(mContext, this, mHandler);
            qs.setupQuickSettingsTile(inflater, mContainerView);
            mQuickSettingsTiles.add(qs);
        }
        if (Settings.System.getIntForUser(resolver,
        		SettingsWrapper.System.QS_DYNAMIC_BUGREPORT, 1, UserHandle.USER_CURRENT) == 1) {
        ...
        if (Settings.System.getIntForUser(resolver,
        		SettingsWrapper.System.QS_DYNAMIC_WIFI, 1, UserHandle.USER_CURRENT) == 1) {
        ...
        if (QSUtils.deviceSupportsImeSwitcher(mContext) && Settings.System.getIntForUser(resolver,
        		SettingsWrapper.System.QS_DYNAMIC_IME, 1, UserHandle.USER_CURRENT) == 1) {
        ...
        if (QSUtils.deviceSupportsUsbTether(mContext) && Settings.System.getIntForUser(resolver,
        		SettingsWrapper.System.QS_DYNAMIC_USBTETHER, 1, UserHandle.USER_CURRENT) == 1) {
    ...
    private void loadDockBatteryTile(final ContentResolver resolver,
        ...
        if (Settings.System.getIntForUser(resolver,
        		SettingsWrapper.System.QS_DYNAMIC_DOCK_BATTERY, 1, UserHandle.USER_CURRENT) == 0) {
            return;
        }
    ...
    protected void setupQuickSettings() {
        ...
        boolean smallIcons = Settings.System.getIntForUser(resolver,
        		SettingsWrapper.System.QUICK_SETTINGS_SMALL_ICONS, 0, UserHandle.USER_CURRENT) == 1;
