...
import android.app.ActivityManagerWrapper;
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
            		SettingsWrapper.System.STATUS_BAR_BRIGHTNESS_CONTROL), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
            		SettingsWrapper.System.SCREEN_BRIGHTNESS_MODE), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
            		SettingsWrapper.System.STATUS_BAR_BATTERY), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
            		SettingsWrapper.System.STATUS_BAR_BATTERY_SHOW_PERCENT), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
            		SettingsWrapper.System.STATUS_BAR_CLOCK), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
            		SettingsWrapper.System.STATUS_BAR_SIGNAL_TEXT), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
            		SettingsWrapper.System.NAVBAR_LEFT_IN_LANDSCAPE), false, this);
            updateSettings();
        }
    ...
    class DevForceNavbarObserver extends ContentObserver {
        ...
        void observe() {
            ContentResolver resolver = mContext.getContentResolver();
            resolver.registerContentObserver(Settings.System.getUriFor(
            		SettingsWrapper.System.DEV_FORCE_SHOW_NAVBAR), false, this);
        }

        @Override
        public void onChange(boolean selfChange) {
            boolean visible = Settings.System.getIntForUser(mContext.getContentResolver(),
            		SettingsWrapper.System.DEV_FORCE_SHOW_NAVBAR, 0, UserHandle.USER_CURRENT) == 1;
            if (visible) {
        ...
        if (mRibbonQS == null) {
            ...
            if (mRibbonContainer != null) {
                String settingsKey = mQuickAccessLayoutLinked
                        ...
                        : SettingsWrapper.System.QUICK_SETTINGS_RIBBON_TILES;
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        if (!ActivityManagerWrapper.isHighEndGfx(mContext.getContentResolver())) {
        ...
        if (mHasSettingsPanel) {
            ...
            if (mSettingsContainer != null) {
                mQS = new QuickSettingsController(mContext, mSettingsContainer, this,
                		SettingsWrapper.System.QUICK_SETTINGS_TILES, false);
                if (!mNotificationPanelIsFullScreenWidth) {
            ...
            mHasQuickAccessSettings = Settings.System.getIntForUser(resolver,
            		SettingsWrapper.System.QS_QUICK_ACCESS, 0, UserHandle.USER_CURRENT) == 1;
            mQuickAccessLayoutLinked = Settings.System.getIntForUser(resolver,
            		SettingsWrapper.System.QS_QUICK_ACCESS_LINKED, 1, UserHandle.USER_CURRENT) == 1;
    ...
    protected void updateCarrierLabelVisibility(boolean force) {
        ...
        final boolean isEmergencyOnly = mNetworkController.isEmergencyOnly();
    ...
    private View.OnClickListener mAddTileButtonListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            intent.setClassName("com.cyanogenmod.settings",
                    "com.cyanogenmod.settings.Settings$QuickSettingsConfigActivity");
    ...
    private void updateSettings() {
        ...
        if (autoBrightnessSetting == Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC) {
            ...
            mBrightnessControl = Settings.System.getIntForUser(resolver,
            		SettingsWrapper.System.STATUS_BAR_BRIGHTNESS_CONTROL, 0, mCurrentUserId) == 1;
        }

        int batteryStyle = Settings.System.getIntForUser(resolver,
        		SettingsWrapper.System.STATUS_BAR_BATTERY, 0, mCurrentUserId);
        ...
        boolean showPercent = Settings.System.getIntForUser(resolver,
        		SettingsWrapper.System.STATUS_BAR_BATTERY_SHOW_PERCENT, 0, mCurrentUserId) == 1;
        ...
        if (mNavigationBarView != null) {
            boolean navLeftInLandscape = Settings.System.getInt(resolver,
            		SettingsWrapper.System.NAVBAR_LEFT_IN_LANDSCAPE, 0) == 1;
            mNavigationBarView.setLeftInLandscape(navLeftInLandscape);
        }

        mClockEnabled = Settings.System.getIntForUser(resolver,
        		SettingsWrapper.System.STATUS_BAR_CLOCK, 1, mCurrentUserId) != 0;
        updateClockVisibility();

        int signalStyle = Settings.System.getIntForUser(resolver,
        		SettingsWrapper.System.STATUS_BAR_SIGNAL_TEXT,
    ...
    private class TilesChangedObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            if (uri != null && uri.equals(Settings.System.getUriFor(
                    SettingsWrapper.System.QS_QUICK_ACCESS))) {
                final ContentResolver resolver = mContext.getContentResolver();
                mHasQuickAccessSettings = Settings.System.getIntForUser(resolver,
                		SettingsWrapper.System.QS_QUICK_ACCESS, 0, UserHandle.USER_CURRENT) == 1;
                if (mHasQuickAccessSettings) {
            		...
            		SettingsWrapper.System.QS_QUICK_ACCESS_LINKED))) {
                final ContentResolver resolver = mContext.getContentResolver();
                ...
                if (mQuickAccessLayoutLinked != layoutLinked) {
            		...
            		SettingsWrapper.System.QUICK_SETTINGS_SMALL_ICONS))) {
                if (mSettingsContainer != null) {
                    mQS.setupQuickSettings();
        ...
        public void startObserving() {
            ...
            cr.registerContentObserver(
                    Settings.System.getUriFor(SettingsWrapper.System.QUICK_SETTINGS_TILES),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.System.getUriFor(SettingsWrapper.System.QS_DYNAMIC_ALARM),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.System.getUriFor(SettingsWrapper.System.QS_DYNAMIC_BUGREPORT),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.System.getUriFor(SettingsWrapper.System.QS_DYNAMIC_DOCK_BATTERY),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.System.getUriFor(SettingsWrapper.System.QS_DYNAMIC_IME),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.System.getUriFor(SettingsWrapper.System.QS_DYNAMIC_USBTETHER),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.System.getUriFor(SettingsWrapper.System.QS_DYNAMIC_WIFI),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.System.getUriFor(SettingsWrapper.System.QS_QUICK_ACCESS),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.System.getUriFor(SettingsWrapper.System.QS_QUICK_ACCESS_LINKED),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.System.getUriFor(SettingsWrapper.System.QUICK_SETTINGS_RIBBON_TILES),
                    false, this, UserHandle.USER_ALL);

            cr.registerContentObserver(
                    Settings.System.getUriFor(SettingsWrapper.System.QUICK_SETTINGS_SMALL_ICONS),
                    false, this, UserHandle.USER_ALL);
