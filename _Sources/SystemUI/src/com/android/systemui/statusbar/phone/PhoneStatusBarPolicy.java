...
public class PhoneStatusBarPolicy {
    ...
    private final void updateHeadset(Intent intent) {
    	...
    	mService.setIcon("headset", microphone == 1 ? 
    			R.drawable.stat_sys_headset_with_mic :
    			R.drawable.stat_sys_headset_without_mic, 0, null);
    	mService.setIconVisibility("headset", state == 1);
    }
    
    private final void updateHeadset() {
    	mService.setIcon("headset", R.drawable.stat_sys_headset_without_mic, 0, null);
    	mService.setIconVisibility("headset", mAudioManager.isWiredHeadsetOn());
    }
