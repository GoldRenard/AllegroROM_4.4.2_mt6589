...
import com.goldrenard.internal.util.cm.ResourcesWrapper;
...
public class NavigationBarView extends LinearLayout {
    ...
    public void onAttachedToWindow() {
        ...
        final String keyguardPackage = ResourcesWrapper.getKeyguardPackage();
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(
                Settings.System.getUriFor(SettingsWrapper.System.LOCKSCREEN_MODLOCK_ENABLED),
                false, this);
        ...
        public void onChange(boolean selfChange) {
            mModLockDisabled = Settings.System.getInt(mContext.getContentResolver(),
            		SettingsWrapper.System.LOCKSCREEN_MODLOCK_ENABLED, 1) == 0;
            setDisabledFlags(mDisabledFlags, true /* force */);
        }
    }
}
