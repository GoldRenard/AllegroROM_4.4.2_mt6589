...
import com.goldrenard.internal.telephony.PhoneUtils;
...
public class LteTile extends QuickSettingsTile {
    ...
    private synchronized void updateTile() {
        ...
        switch(network) {
            ...
            case PhoneUtils.NT_MODE_TD_SCDMA_GSM_WCDMA_LTE:
            case PhoneUtils.NT_MODE_TD_SCDMA_WCDMA_LTE:
