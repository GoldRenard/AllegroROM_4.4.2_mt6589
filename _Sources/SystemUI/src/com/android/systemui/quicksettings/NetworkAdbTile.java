...
public class NetworkAdbTile extends QuickSettingsTile {
    ...
    public NetworkAdbTile(Context context, QuickSettingsController qsc) {
        ...
        mOnClick = new OnClickListener() {
            ...
            public void onClick(View v) {
                Settings.Secure.putInt(mContext.getContentResolver(),
                		SettingsWrapper.Secure.ADB_PORT, !getEnabled() ? 5555 : -1);
            }
        };
        ...
        qsc.registerObservedContent(Settings.Secure.getUriFor(SettingsWrapper.Secure.ADB_PORT), this);
        updateResources();
    }
    ...
    private boolean getEnabled() {
        return Settings.Secure.getInt(mContext.getContentResolver(),
        		SettingsWrapper.Secure.ADB_PORT, 0) > 0;
    }
}
