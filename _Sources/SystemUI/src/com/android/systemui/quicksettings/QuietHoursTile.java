...
import com.goldrenard.internal.util.cm.QuietHoursUtils;
...
public class QuietHoursTile extends QuickSettingsTile {
    ...
    public QuietHoursTile(Context context, QuickSettingsController qsc) {
        ...
        qsc.registerObservedContent(
                Settings.System.getUriFor(SettingsWrapper.System.QUIET_HOURS_ENABLED), this);
        qsc.registerObservedContent(
                Settings.System.getUriFor(SettingsWrapper.System.QUIET_HOURS_FORCED), this);
        qsc.registerObservedContent(
                Settings.System.getUriFor(SettingsWrapper.System.QUIET_HOURS_START), this);
        qsc.registerObservedContent(
                Settings.System.getUriFor(SettingsWrapper.System.QUIET_HOURS_END), this);
    }
    ...
    public void updateResources() {
        mEnabled = Settings.System.getIntForUser(mContext.getContentResolver(),
        		SettingsWrapper.System.QUIET_HOURS_ENABLED, 0, UserHandle.USER_CURRENT) == 1;
        mForced = Settings.System.getIntForUser(mContext.getContentResolver(),
        		SettingsWrapper.System.QUIET_HOURS_FORCED, 0, UserHandle.USER_CURRENT) == 1;
        mStart = Settings.System.getIntForUser(mContext.getContentResolver(),
        		SettingsWrapper.System.QUIET_HOURS_START, 0, UserHandle.USER_CURRENT);
        mEnd = Settings.System.getIntForUser(mContext.getContentResolver(),
        		SettingsWrapper.System.QUIET_HOURS_END, 0, UserHandle.USER_CURRENT);
    ...
    private void toggleState() {
        ...
        Settings.System.putIntForUser(mContext.getContentResolver(),
        		SettingsWrapper.System.QUIET_HOURS_ENABLED,
                mEnabled ? 1 : 0, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(mContext.getContentResolver(),
        		SettingsWrapper.System.QUIET_HOURS_FORCED,
