...
public class PerformanceProfileTile extends QuickSettingsTile {
    ...
    public PerformanceProfileTile(Context context, QuickSettingsController qsc) {
        ...
        mEntries = res.getStringArray(R.array.perf_profile_entries);
        ...
        mPerfProfileValues = res.getStringArray(R.array.perf_profile_values);
        ...
        qsc.registerObservedContent(Settings.Secure.getUriFor(
        		SettingsWrapper.Secure.PERFORMANCE_PROFILE), this);
    ...
    private void updateCurrentValue() {
        ...
        String perfProfile = mPerfProfileDefaultEntry;
        if (perfProfile == null) {
