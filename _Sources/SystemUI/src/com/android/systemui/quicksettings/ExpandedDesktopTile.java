...
public class ExpandedDesktopTile extends QuickSettingsTile {
    ...
    public ExpandedDesktopTile(Context context,
        ...
        mOnClick = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Settings.System.putIntForUser(mContext.getContentResolver(),
                		SettingsWrapper.System.EXPANDED_DESKTOP_STATE, mEnabled ? 0 : 1,
        ...
        Uri stateUri = Settings.System.getUriFor(SettingsWrapper.System.EXPANDED_DESKTOP_STATE);
    ...
    private synchronized void updateTile() {
        mEnabled = Settings.System.getIntForUser(mContext.getContentResolver(),
        		SettingsWrapper.System.EXPANDED_DESKTOP_STATE, 0, UserHandle.USER_CURRENT) == 1;
        if (mEnabled) {
