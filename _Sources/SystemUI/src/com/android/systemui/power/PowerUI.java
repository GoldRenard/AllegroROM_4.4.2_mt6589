...
public class PowerUI extends SystemUI {
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                if (mIgnoreFirstPowerEvent) {
                    ...
                    if (Settings.Global.getInt(cr,
                            SettingsWrapper.Global.POWER_NOTIFICATIONS_ENABLED, 0) == 1) {
    ...
    void playPowerNotificationSound() {
        ...
        final String soundPath =
                Settings.Global.getString(cr, SettingsWrapper.Global.POWER_NOTIFICATIONS_RINGTONE);
        ...
        if (Settings.Global.getInt(cr,
        		SettingsWrapper.Global.POWER_NOTIFICATIONS_VIBRATE, 0) == 0) {
