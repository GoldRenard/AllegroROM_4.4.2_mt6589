        ...
        VolumeController
{
    ...
    private enum StreamResources {
        ...
        FMStream(AudioManager.STREAM_FM,
        		33882193, 
                utils.R.drawable.ic_radio_vol,
                utils.R.drawable.ic_radio_vol_off,
        		false),
    ...
    private ContentObserver mSettingsObserver = new ContentObserver(this) {
        ...
        public void onChange(boolean selfChange) {
            mVolumeLinkNotification = Settings.System.getInt(mContext.getContentResolver(),
                    SettingsWrapper.System.VOLUME_LINK_NOTIFICATION, 1) == 1;
            final int overlayStyle = Settings.System.getInt(mContext.getContentResolver(),
            		SettingsWrapper.System.MODE_VOLUME_OVERLAY, VOLUME_OVERLAY_EXPANDABLE);
    ...
    public VolumePanel(final Context context, AudioService volumeService) {
        ...
        context.getContentResolver().registerContentObserver(
                Settings.System.getUriFor(SettingsWrapper.System.VOLUME_LINK_NOTIFICATION), false,
                mSettingsObserver);
        context.getContentResolver().registerContentObserver(
                Settings.System.getUriFor(SettingsWrapper.System.MODE_VOLUME_OVERLAY), false,
                mSettingsObserver);
...
//                setRingerIcon();
    ...
    protected void onPlaySound(int streamType, int flags) {
        ...
        if (Settings.System.getInt(mContext.getContentResolver(),
        		SettingsWrapper.System.VOLUME_ADJUST_SOUNDS_ENABLED, 1) == 0) {
             return;
         }
    ...
    protected void onDisplaySafeVolumeWarning(int flags) {
        if ((flags & AudioManager.FLAG_SHOW_UI) != 0 || mDialog.isShowing()) {
            synchronized (sConfirmSafeVolumeLock) {
                ...
                if (Settings.System.getInt(mContext.getContentResolver(), 
                		SettingsWrapper.System.VOLUME_WARNING_DISABLED, 0) != 0) {
