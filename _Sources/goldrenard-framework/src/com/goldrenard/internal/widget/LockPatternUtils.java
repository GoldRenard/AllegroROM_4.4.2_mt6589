...
package com.goldrenard.internal.widget;
    ...
    */
    ...
    public static List<LockPatternView.Cell> stringToPattern(String string) {
        ...
        for (int i = 0; i < bytes.length; i++) {
            byte b = bytes[i];
            result.add(LockPatternView.Cell.of(b / 3, b % 3, (byte)3));
        }
        return result;
    }
    ...
    public void setLockPatternSize(long size) {
        setLong(SettingsWrapper.Secure.LOCK_PATTERN_SIZE, size);
    }

    public void setVisibleDotsEnabled(boolean enabled) {
        setBoolean(SettingsWrapper.Secure.LOCK_DOTS_VISIBLE, enabled);
    }

    public boolean isVisibleDotsEnabled() {
        return getBoolean(SettingsWrapper.Secure.LOCK_DOTS_VISIBLE, true);
    }

    public void setShowErrorPath(boolean enabled) {
        setBoolean(SettingsWrapper.Secure.LOCK_SHOW_ERROR_PATH, enabled);
    }

    public boolean isShowErrorPath() {
        return getBoolean(SettingsWrapper.Secure.LOCK_SHOW_ERROR_PATH, true);
    }
    ...
    public void setLockBeforeUnlock(boolean enabled) {
        setBoolean(SettingsWrapper.Secure.LOCK_BEFORE_UNLOCK, enabled);
    }
