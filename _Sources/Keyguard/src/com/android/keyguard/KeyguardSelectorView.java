...
import com.goldrenard.internal.telephony.IccCardConstants.State;
import com.goldrenard.internal.util.cm.LockscreenTargetUtils;
...
import com.goldrenard.internal.widget.multiwaveview.GlowPadView.OnTriggerListener;
...
public class KeyguardSelectorView extends LinearLayout implements KeyguardSecurityView {
    ...
    protected void onFinishInflate() {
        ...
        if (Settings.System.getInt(mContext.getContentResolver(),
                    SettingsWrapper.System.DOUBLE_TAP_SLEEP_GESTURE, 0) == 1) {
    ...
    public void updateResources() {
        String storedTargets = Settings.System.getStringForUser(mContext.getContentResolver(),
        		SettingsWrapper.System.LOCKSCREEN_TARGETS, UserHandle.USER_CURRENT);
