...
import com.goldrenard.internal.telephony.IccCardConstants;
...
public class KeyguardViewMediator {
    ...
    public void onScreenTurnedOff(int why) {
        synchronized (this) {
            ...
            boolean separateSlideLockTimeoutEnabled = Settings.System.getInt(cr,
                    SettingsWrapper.System.SCREEN_LOCK_SLIDE_DELAY_TOGGLE, 0) == 1;
    ...
    private void doKeyguardLaterLocked() {
        ...
        if (mSlideLockDelay == WindowManagerPolicy.OFF_BECAUSE_OF_TIMEOUT) {
            slideLockTimeoutDelay = Settings.System.getInt(cr,
            		SettingsWrapper.System.SCREEN_LOCK_SLIDE_TIMEOUT_DELAY,
                    KEYGUARD_LOCK_AFTER_DELAY_DEFAULT);
        } else {
            slideLockTimeoutDelay = Settings.System.getInt(cr,
            		SettingsWrapper.System.SCREEN_LOCK_SLIDE_SCREENOFF_DELAY, 0);
        }
    ...
    private void playSounds(boolean locked) {
        ...
        if (QuietHoursUtils.inQuietHours(mContext, SettingsWrapper.System.QUIET_HOURS_SYSTEM)) {
            return;
        }
