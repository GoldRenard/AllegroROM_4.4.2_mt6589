...
public class KeyguardUpdateMonitor {
    ...
    private static class SimArgs {
        ...
        static SimArgs fromIntent(Intent intent) {
            ...
            subscription = intent.getIntExtra("subscription", 0);
    ...
    public static boolean shouldAlwaysShowBatteryInfo(Context context) {
        return Settings.System.getInt(context.getContentResolver(),
                SettingsWrapper.System.LOCKSCREEN_BATTERY_VISIBILITY, 0) == 1;
    }

    public static boolean shouldNeverShowBatteryInfo(Context context) {
        return Settings.System.getInt(context.getContentResolver(),
        		SettingsWrapper.System.LOCKSCREEN_BATTERY_VISIBILITY, 0) == 2;
    }
