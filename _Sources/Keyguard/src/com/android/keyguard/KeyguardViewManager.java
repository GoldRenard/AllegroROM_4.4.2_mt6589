...
public class KeyguardViewManager {
    ...
    private boolean shouldEnableScreenRotation() {
        ...
        boolean enableLockScreenRotation = Settings.System.getInt(mContext.getContentResolver(),
                SettingsWrapper.System.LOCKSCREEN_ROTATION, 0) != 0;
        ...
        if (event.isLongPress()) {
            ...
            switch (keyCode) {
                case KeyEvent.KEYCODE_BACK:
                    action = SettingsWrapper.System.LOCKSCREEN_LONG_BACK_ACTION;
                    break;
                case KeyEvent.KEYCODE_HOME:
                    action = SettingsWrapper.System.LOCKSCREEN_LONG_HOME_ACTION;
                    break;
                case KeyEvent.KEYCODE_MENU:
                    action = SettingsWrapper.System.LOCKSCREEN_LONG_MENU_ACTION;
                    break;
            }
